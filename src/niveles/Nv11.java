...
public class Nv11 implements IPantalla{
	...
	public void inicializarPantalla(PanelJuego panel) {
		...
		//CREACIÓN GATOS
		smallGatoVerde = new Sprite(300, 150, 195,95, new Color(141,214,116));
		smallGatoNaranja = new Sprite(400, 450, 95, 195, new Color(252, 148, 58));
		smallGatoMorado  = new Sprite(700, 550, 95, 195, new Color(127, 44, 207));
		
		bigGatoLila = new Sprite(500, 150, 95, 295, new Color(192, 152, 240));
		bigGatoAmarillo = new Sprite(200, 150, 95, 295, new Color(255,235,67));
