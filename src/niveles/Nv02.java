...
/**
 * Nivel 2 de dificultad Principiante (nivel 02).
 * 
...
public class Nv02 implements IPantalla {
	...
	public void inicializarPantalla(PanelJuego panel) {
		...
		smallGatoVerde = new Sprite(200, 150, 95, 195, new Color(141, 214, 116), new Entidad(0, 1, 2, 0, 0));
		smallGatoNaranja = new Sprite(500, 250, 95, 195, new Color(252, 148, 58), new Entidad(1, 1, 2, 3, 1));
		smallGatoAzul = new Sprite(600, 350, 95, 195, new Color(64, 196, 232), new Entidad(2, 1, 2, 4, 2));
		smallGatoVerde2 = new Sprite(200, 650, 195, 95, new Color(19, 135, 24), new Entidad(3, 2, 1, 0, 5));
		smallGatoRosa = new Sprite(400, 550, 95, 195, new Color(255, 143, 216), new Entidad(4, 1, 2, 2, 4));
		smallGatoNegro = new Sprite(500, 650, 195, 95, new Color(54, 49, 53), new Entidad(5, 2, 1, 3, 5));
		smallGatoMorado = new Sprite(600, 550, 195, 95, new Color(127, 44, 207), new Entidad(6, 2, 1, 4, 4));

		bigGatoLila = new Sprite(700, 250, 95, 295, new Color(192, 152, 240), new Entidad(7, 1, 3, 5, 1));
		bigGatoAmarillo = new Sprite(500, 150, 295, 95, new Color(255, 235, 67), new Entidad(8, 3, 1, 3, 0));
		bigGatoAzul = new Sprite(200, 450, 295, 95, new Color(24, 46, 152), new Entidad(9, 3, 1, 0, 3));

		// Indicamos qué gatos son los que están en posición vertical
		smallGatoVerde.getData().setVertical(true);
		smallGatoRosa.getData().setVertical(true);
		smallGatoNaranja.getData().setVertical(true);
		smallGatoAzul.getData().setVertical(true);
		...
		sprites.put(smallGatoVerde2.getData().getId(), smallGatoVerde2);
		sprites.put(smallGatoRosa.getData().getId(), smallGatoRosa);
		sprites.put(smallGatoNegro.getData().getId(), smallGatoNegro);
		...
		// CREACIÓN PÁJARO
		pajaro = new Sprite(200, 350, 195, 95, Color.RED, new Entidad(10, 2, 1, 0, 2));
